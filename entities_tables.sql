...
# Database: project
# Generation Time: 2022-07-08 18:39:35 +0000
# ************************************************************
...
CREATE TABLE `address_book` (
  ...
  `is_deleted` char(11) COLLATE utf8_bin NOT NULL DEFAULT 'N' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='地址管理';
...
CREATE TABLE `dish_flavor` (
  ...
  `create_user` bigint(20) NOT NULL COMMENT '创建人',
  `update_user` bigint(20) NOT NULL COMMENT '修改人',
  `is_deleted` varchar(11) COLLATE utf8_bin NOT NULL DEFAULT 'N' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='员工信息';
...
CREATE TABLE `order_detail` (
  ...
  `is_deleted` char(11) COLLATE utf8_bin DEFAULT 'N',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='订单明细表';
...
CREATE TABLE `shopping_cart` (
  ...
  `create_user` bigint(11) NOT NULL COMMENT '创建者',
  `update_user` bigint(11) NOT NULL COMMENT '更新者',
  `is_deleted` char(11) COLLATE utf8_bin NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='购物车';
...
CREATE TABLE `user` (
  ...
  `email` varchar(100) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '手机号',
  `sex` varchar(2) COLLATE utf8_bin DEFAULT NULL COMMENT '性别',
  `id_number` varchar(18) COLLATE utf8_bin DEFAULT NULL COMMENT '身份证号',
  `avatar` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT '头像',
  `status` int(11) DEFAULT '0' COMMENT '状态 0:禁用，1:正常',
  `is_deleted` char(11) CHARACTER SET utf8 NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1545333229925171202 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户信息';
